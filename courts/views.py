...
class RecurrenceView(View):
    ...
    Generate open-availability slots on a recurring weekly schedule.
    ...
    Constraints:
      ...
      - Overlapping slots are silently skipped.
      - Days outside court operating_hours are silently skipped.
    """
